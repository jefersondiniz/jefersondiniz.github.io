...
If you use Windows 10, change this line on [gulpfile.js](https://github.com/willianjusten/will-jekyll-template/blob/gh-pages/gulpfile.js#L23) to `return cp.spawn('jekyll', ['build'], {stdio: 'inherit'})`.
